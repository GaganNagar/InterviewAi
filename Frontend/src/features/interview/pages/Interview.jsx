            ...
            <div className="flex flex-col lg:flex-row min-h-screen max-w-[1600px] mx-auto">
                ...
                <nav className="w-full lg:w-72 bg-[#141414] lg:border-r border-white/5 p-6 flex flex-col justify-between">
                    ...
                    <motion.button
                        ...
                        className="mt-10 lg:mt-0 flex items-center justify-center gap-3 bg-white/5 border border-white/10 py-4 rounded-xl text-sm font-bold hover:bg-white/10 transition-all"
                    >
