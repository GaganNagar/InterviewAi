...
const Register = () => {
    ...
    // Professional Loading State matching other components
    if (loading) {
        return (
    ...
    return (
        <main className="min-h-screen w-full flex justify-center items-center bg-darkBg px-4">
            ...
            <motion.div
                ...
                className="w-full max-w-[450px] flex flex-col gap-6 bg-[#1c1c1c] p-10 rounded-3xl shadow-2xl border border-white/5"
            >
                <div className="flex flex-col gap-2">
                    <h1 className="text-4xl font-bold tracking-tight text-white">Register</h1>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                    ...
                    <motion.button
                        ...
                        whileTap={{ scale: 0.99 }}
                        className="bg-primary text-white font-bold py-4 rounded-xl mt-2 shadow-lg shadow-primary/20 hover:bg-[#b50b33] transition-colors"
                    >
                        Register
                    </motion.button>
                </form>
                ...
                <p className="text-center text-sm text-gray-400">
                    ...
                    <Link to={"/login"} className="text-primary hover:text-[#e1034d] ml-1.5 font-semibold transition-all hover:underline underline-offset-4">
                        Login
                    </Link>
                </p>
            </motion.div>
